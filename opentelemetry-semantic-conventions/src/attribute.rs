...
#[cfg(feature = "semconv_experimental")]
pub const BROWSER_DOCUMENT_URL_FULL: &str = "browser.document.url.full";
...
/// - `201`
#[cfg(feature = "semconv_experimental")]
#[deprecated(note = "{note: Use `db.response.status_code` instead., reason: uncategorized}")]
...
/// - `15`
#[cfg(feature = "semconv_experimental")]
#[deprecated(note = "{note: Uncategorized., reason: uncategorized}")]
...
/// - `"admin"`
#[cfg(feature = "semconv_experimental")]
#[deprecated(note = "{note: Use `user.roles` instead., reason: uncategorized}")]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Use domain-specific error message attribute. For example, use `feature_flag.error.message` for feature flag errors., reason: obsoleted}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: The value of this attribute MUST now be set as the value of the EventName field on the LogRecord to indicate that the LogRecord represents an Event.\n, reason: uncategorized}"
)]
...
/// - `"The user has exceeded their storage quota"`
#[cfg(feature = "semconv_experimental")]
pub const FEATURE_FLAG_ERROR_MESSAGE: &str = "feature_flag.error.message";
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `feature_flag.error.message`., reason: renamed, renamed_to: feature_flag.error.message}"
)]
...
/// - `"LEASE"`
#[cfg(feature = "semconv_experimental")]
pub const FILE_LOCK_MECHANISM: &str = "file.lock.mechanism";
...
/// - `"BREAKER"`
#[cfg(feature = "semconv_experimental")]
pub const FILE_LOCK_MODE: &str = "file.lock.mode";
...
/// - `"read"`
#[cfg(feature = "semconv_experimental")]
pub const FILE_LOCK_TYPE: &str = "file.lock.type";
...
/// - `"projects/my-container-project"`
#[cfg(feature = "semconv_experimental")]
pub const GCP_APPHUB_DESTINATION_APPLICATION_CONTAINER: &str =
...
/// - `"my-application"`
#[cfg(feature = "semconv_experimental")]
pub const GCP_APPHUB_DESTINATION_APPLICATION_ID: &str = "gcp.apphub_destination.application.id";
...
/// - `"us-central1"`
#[cfg(feature = "semconv_experimental")]
pub const GCP_APPHUB_DESTINATION_APPLICATION_LOCATION: &str =
...
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const GCP_APPHUB_DESTINATION_SERVICE_CRITICALITY_TYPE: &str =
...
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const GCP_APPHUB_DESTINATION_SERVICE_ENVIRONMENT_TYPE: &str =
...
/// - `"my-service"`
#[cfg(feature = "semconv_experimental")]
pub const GCP_APPHUB_DESTINATION_SERVICE_ID: &str = "gcp.apphub_destination.service.id";

/// Criticality of a destination workload indicates its importance to the business as specified in [AppHub type enum](https://cloud.google.com/app-hub/docs/reference/rest/v1/Attributes#type)
///
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const GCP_APPHUB_DESTINATION_WORKLOAD_CRITICALITY_TYPE: &str =
...
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const GCP_APPHUB_DESTINATION_WORKLOAD_ENVIRONMENT_TYPE: &str =
...
/// - `"my-workload"`
#[cfg(feature = "semconv_experimental")]
pub const GCP_APPHUB_DESTINATION_WORKLOAD_ID: &str = "gcp.apphub_destination.workload.id";
...
/// - `"observability"`
#[cfg(feature = "semconv_experimental")]
pub const GCP_GCE_INSTANCE_LABELS: &str = "gcp.gce.instance.labels";
...
/// - `"my-managed-group"`
#[cfg(feature = "semconv_experimental")]
pub const GCP_GCE_INSTANCE_GROUP_MANAGER_NAME: &str = "gcp.gce.instance_group_manager.name";
...
/// - `"europe-west1"`
#[cfg(feature = "semconv_experimental")]
pub const GCP_GCE_INSTANCE_GROUP_MANAGER_REGION: &str = "gcp.gce.instance_group_manager.region";
...
/// - `"europe-west1-b"`
#[cfg(feature = "semconv_experimental")]
pub const GCP_GCE_INSTANCE_GROUP_MANAGER_ZONE: &str = "gcp.gce.instance_group_manager.zone";
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `gen_ai.output.type`, which has moved to the [OpenTelemetry GenAI semantic conventions repository](https://github.com/open-telemetry/semantic-conventions-genai).\n, reason: uncategorized}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `gen_ai.request.seed`, which has moved to the [OpenTelemetry GenAI semantic conventions repository](https://github.com/open-telemetry/semantic-conventions-genai).\n, reason: uncategorized}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `openai.request.service_tier`, which has moved to the [OpenTelemetry GenAI semantic conventions repository](https://github.com/open-telemetry/semantic-conventions-genai).\n, reason: uncategorized}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `openai.response.service_tier`, which has moved to the [OpenTelemetry GenAI semantic conventions repository](https://github.com/open-telemetry/semantic-conventions-genai).\n, reason: uncategorized}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `openai.response.system_fingerprint`, which has moved to the [OpenTelemetry GenAI semantic conventions repository](https://github.com/open-telemetry/semantic-conventions-genai).\n, reason: uncategorized}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `gen_ai.provider.name`, which has moved to the [OpenTelemetry GenAI semantic conventions repository](https://github.com/open-telemetry/semantic-conventions-genai).\n, reason: uncategorized}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `gen_ai.usage.output_tokens`, which has moved to the [OpenTelemetry GenAI semantic conventions repository](https://github.com/open-telemetry/semantic-conventions-genai).\n, reason: uncategorized}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `gen_ai.usage.input_tokens`, which has moved to the [OpenTelemetry GenAI semantic conventions repository](https://github.com/open-telemetry/semantic-conventions-genai).\n, reason: uncategorized}"
)]
...
/// - `"gc/mark/assist"`
#[cfg(feature = "semconv_experimental")]
pub const GO_CPU_DETAILED_STATE: &str = "go.cpu.detailed_state";
...
/// - `"gc"`
#[cfg(feature = "semconv_experimental")]
pub const GO_CPU_STATE: &str = "go.cpu.state";
...
/// - `"heap/free"`
#[cfg(feature = "semconv_experimental")]
pub const GO_MEMORY_DETAILED_TYPE: &str = "go.memory.detailed_type";
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Split into `network.protocol.name` and `network.protocol.version`, reason: uncategorized}"
)]
...
/// - `"logs"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_CONTAINER_EPHEMERAL_STORAGE_FS_TYPE: &str = "k8s.container.ephemeral_storage.fs_type";
...
/// - `"misc"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_NODE_SYSTEM_CONTAINER_NAME: &str = "k8s.node.system_container.name";
...
/// - `""`
#[cfg(feature = "semconv_experimental")]
pub const K8S_PERSISTENTVOLUME_ANNOTATION: &str = "k8s.persistentvolume.annotation";
...
/// - `""`
#[cfg(feature = "semconv_experimental")]
pub const K8S_PERSISTENTVOLUME_LABEL: &str = "k8s.persistentvolume.label";
...
/// - `"pv-data-01"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_PERSISTENTVOLUME_NAME: &str = "k8s.persistentvolume.name";
...
/// - `"Recycle"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_PERSISTENTVOLUME_RECLAIM_POLICY: &str = "k8s.persistentvolume.reclaim_policy";
...
/// - `"275ecb36-5aa8-4c2a-9c47-d8bb681b9aff"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_PERSISTENTVOLUME_UID: &str = "k8s.persistentvolume.uid";
...
/// - `""`
#[cfg(feature = "semconv_experimental")]
pub const K8S_PERSISTENTVOLUMECLAIM_ANNOTATION: &str = "k8s.persistentvolumeclaim.annotation";
...
/// - `""`
#[cfg(feature = "semconv_experimental")]
pub const K8S_PERSISTENTVOLUMECLAIM_LABEL: &str = "k8s.persistentvolumeclaim.label";
...
/// - `"pvc-data-01"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_PERSISTENTVOLUMECLAIM_NAME: &str = "k8s.persistentvolumeclaim.name";
...
/// - `"275ecb36-5aa8-4c2a-9c47-d8bb681b9aff"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_PERSISTENTVOLUMECLAIM_UID: &str = "k8s.persistentvolumeclaim.uid";
...
///
/// - `"collector-gateway"`
pub const K8S_POD_HOSTNAME: &str = "k8s.pod.hostname";
...
///
/// - `"172.18.0.2"`
pub const K8S_POD_IP: &str = "k8s.pod.ip";
...
pub const K8S_POD_START_TIME: &str = "k8s.pod.start_time";
...
/// - `""`
#[cfg(feature = "semconv_experimental")]
pub const K8S_SERVICE_ANNOTATION: &str = "k8s.service.annotation";
...
/// - `"IPv6"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_SERVICE_ENDPOINT_ADDRESS_TYPE: &str = "k8s.service.endpoint.address_type";
...
/// - `"terminating"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_SERVICE_ENDPOINT_CONDITION: &str = "k8s.service.endpoint.condition";
...
/// - `""`
#[cfg(feature = "semconv_experimental")]
pub const K8S_SERVICE_ENDPOINT_ZONE: &str = "k8s.service.endpoint.zone";
...
/// - `""`
#[cfg(feature = "semconv_experimental")]
pub const K8S_SERVICE_LABEL: &str = "k8s.service.label";
...
/// - `false`
#[cfg(feature = "semconv_experimental")]
pub const K8S_SERVICE_PUBLISH_NOT_READY_ADDRESSES: &str = "k8s.service.publish_not_ready_addresses";
...
/// - `"v1"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_SERVICE_SELECTOR: &str = "k8s.service.selector";
...
/// - `"PreferSameNode"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_SERVICE_TRAFFIC_DISTRIBUTION: &str = "k8s.service.traffic_distribution";
...
/// - `"LoadBalancer"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_SERVICE_TYPE: &str = "k8s.service.type";
...
/// - `"275ecb36-5aa8-4c2a-9c47-d8bb681b9aff"`
#[cfg(feature = "semconv_experimental")]
pub const K8S_SERVICE_UID: &str = "k8s.service.uid";
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `system.memory.linux.slab.state`., reason: renamed, renamed_to: system.memory.linux.slab.state}"
)]
...
/// ## Notes
#[cfg(feature = "semconv_experimental")]
#[deprecated(note = "{note: Deprecated, no replacement at this time., reason: obsoleted}")]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Record string representation of the partition id in `messaging.destination.partition.id` attribute., reason: uncategorized}"
)]
...
/// - `"GETATTR"`
#[cfg(feature = "semconv_experimental")]
pub const NFS_OPERATION_NAME: &str = "nfs.operation.name";
...
/// - `"hit"`
#[cfg(feature = "semconv_experimental")]
pub const NFS_SERVER_REPCACHE_STATUS: &str = "nfs.server.repcache.status";
...
/// - `"GETATTR"`
#[cfg(feature = "semconv_experimental")]
pub const ONC_RPC_PROCEDURE_NAME: &str = "onc_rpc.procedure.name";

/// ONC/Sun RPC procedure number.
///
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const ONC_RPC_PROCEDURE_NUMBER: &str = "onc_rpc.procedure.number";
...
/// - `"nfs"`
#[cfg(feature = "semconv_experimental")]
pub const ONC_RPC_PROGRAM_NAME: &str = "onc_rpc.program.name";

/// ONC/Sun RPC program version.
///
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const ONC_RPC_VERSION: &str = "onc_rpc.version";
...
/// - `"opentelemetry"`
#[cfg(feature = "semconv_experimental")]
pub const OPENSHIFT_CLUSTERQUOTA_NAME: &str = "openshift.clusterquota.name";
...
/// - `"275ecb36-5aa8-4c2a-9c47-d8bb681b9aff"`
#[cfg(feature = "semconv_experimental")]
pub const OPENSHIFT_CLUSTERQUOTA_UID: &str = "openshift.clusterquota.uid";
...
/// - `"prod.db.local"`
#[cfg(feature = "semconv_experimental")]
pub const ORACLE_DB_DOMAIN: &str = "oracle.db.domain";
...
/// - `"ORCL3"`
#[cfg(feature = "semconv_experimental")]
pub const ORACLE_DB_INSTANCE_NAME: &str = "oracle.db.instance.name";
...
/// - `"FREE"`
#[cfg(feature = "semconv_experimental")]
pub const ORACLE_DB_NAME: &str = "oracle.db.name";
...
/// - `"FREEPDB"`
#[cfg(feature = "semconv_experimental")]
pub const ORACLE_DB_PDB: &str = "oracle.db.pdb";
...
#[cfg(feature = "semconv_experimental")]
pub const ORACLE_DB_SERVICE: &str = "oracle.db.service";
...
/// - `"oc2"`
#[cfg(feature = "semconv_experimental")]
pub const ORACLE_CLOUD_REALM: &str = "oracle_cloud.realm";
...
/// - `"browser.mouse.click"`
/// - `"device.app.lifecycle"`
pub const OTEL_EVENT_NAME: &str = "otel.event.name";
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `service.peer.name`., reason: renamed, renamed_to: service.peer.name}"
)]
...
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const PPROF_LOCATION_IS_FOLDED: &str = "pprof.location.is_folded";

/// Indicates that there are filenames related to this mapping.
///
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const PPROF_MAPPING_HAS_FILENAMES: &str = "pprof.mapping.has_filenames";

/// Indicates that there are functions related to this mapping.
///
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const PPROF_MAPPING_HAS_FUNCTIONS: &str = "pprof.mapping.has_functions";

/// Indicates that there are inline frames related to this mapping.
///
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const PPROF_MAPPING_HAS_INLINE_FRAMES: &str = "pprof.mapping.has_inline_frames";

/// Indicates that there are line numbers related to this mapping.
///
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const PPROF_MAPPING_HAS_LINE_NUMBERS: &str = "pprof.mapping.has_line_numbers";
...
/// ]`
#[cfg(feature = "semconv_experimental")]
pub const PPROF_PROFILE_COMMENT: &str = "pprof.profile.comment";
...
#[cfg(feature = "semconv_experimental")]
pub const PPROF_PROFILE_DOC_URL: &str = "pprof.profile.doc_url";
...
/// - `"/foobar/"`
#[cfg(feature = "semconv_experimental")]
pub const PPROF_PROFILE_DROP_FRAMES: &str = "pprof.profile.drop_frames";
...
/// - `"/bazinga/"`
#[cfg(feature = "semconv_experimental")]
pub const PPROF_PROFILE_KEEP_FRAMES: &str = "pprof.profile.keep_frames";
...
/// - `"cpu"`
#[cfg(feature = "semconv_experimental")]
pub const PPROF_SCOPE_DEFAULT_SAMPLE_TYPE: &str = "pprof.scope.default_sample_type";
...
/// ]`
#[cfg(feature = "semconv_experimental")]
pub const PPROF_SCOPE_SAMPLE_TYPE_ORDER: &str = "pprof.scope.sample_type_order";
...
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const PROCESS_CONTEXT_SWITCH_TYPE: &str = "process.context_switch.type";
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `system.paging.fault.type`., reason: renamed, renamed_to: system.paging.fault.type}"
)]
...
/// - `"running"`
#[cfg(feature = "semconv_experimental")]
pub const PROCESS_STATE: &str = "process.state";
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `rpc.response.status_code`., reason: renamed, renamed_to: rpc.response.status_code}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `rpc.request.metadata`., reason: renamed, renamed_to: rpc.request.metadata}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `rpc.response.metadata`., reason: renamed, renamed_to: rpc.response.metadata}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Use string representation of the gRPC status code on the `rpc.response.status_code` attribute., reason: uncategorized}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Use string representation of the error code on the `rpc.response.status_code` attribute., reason: uncategorized}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Use the span status description when reporting JSON-RPC spans., reason: uncategorized}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `jsonrpc.request.id`., reason: renamed, renamed_to: jsonrpc.request.id}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `jsonrpc.protocol.version`., reason: renamed, renamed_to: jsonrpc.protocol.version}"
)]
...
/// - `"InvalidMethod"`
#[cfg(feature = "semconv_experimental")]
pub const RPC_METHOD_ORIGINAL: &str = "rpc.method_original";
...
/// ]`
#[cfg(feature = "semconv_experimental")]
pub const RPC_REQUEST_METADATA: &str = "rpc.request.metadata";
...
/// ]`
#[cfg(feature = "semconv_experimental")]
pub const RPC_RESPONSE_METADATA: &str = "rpc.response.metadata";
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Value should be included in `rpc.method` which is expected to be a fully-qualified name., reason: uncategorized}"
)]
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `rpc.system.name`., reason: renamed, renamed_to: rpc.system.name}"
)]
...
/// - `"shoppingcart"`
#[cfg(feature = "semconv_experimental")]
pub const SERVICE_PEER_NAME: &str = "service.peer.name";
...
/// - `"Shop"`
#[cfg(feature = "semconv_experimental")]
pub const SERVICE_PEER_NAMESPACE: &str = "service.peer.namespace";
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `cpu.logical_number`., reason: renamed, renamed_to: cpu.logical_number}"
)]
...
/// - `"used"`
#[cfg(feature = "semconv_experimental")]
pub const SYSTEM_MEMORY_LINUX_HUGEPAGES_STATE: &str = "system.memory.linux.hugepages.state";
...
/// - `"unreclaimable"`
#[cfg(feature = "semconv_experimental")]
pub const SYSTEM_MEMORY_LINUX_SLAB_STATE: &str = "system.memory.linux.slab.state";
...
/// - `"minor"`
#[cfg(feature = "semconv_experimental")]
pub const SYSTEM_PAGING_FAULT_TYPE: &str = "system.paging.fault.type";
...
#[cfg(feature = "semconv_experimental")]
#[deprecated(
    note = "{note: Replaced by `process.state`., reason: renamed, renamed_to: process.state}"
)]
...
/// ## Notes
#[cfg(feature = "semconv_experimental")]
pub const V8JS_RESOURCE_TYPE: &str = "v8js.resource.type";
