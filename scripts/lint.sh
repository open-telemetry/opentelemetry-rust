...
if rustup component add clippy && \
  ...
  cargo_feature opentelemetry-otlp "http-json,logs"
  ...
  cargo_feature opentelemetry-proto "gen-tonic-messages,trace,with-serde"
  ...
  cargo_feature opentelemetry-proto "gen-tonic-messages,metrics,with-serde"
  ...
  cargo_feature opentelemetry-proto "gen-tonic-messages,logs,with-serde"
