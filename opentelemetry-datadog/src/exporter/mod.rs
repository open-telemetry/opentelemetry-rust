...
#[derive(Debug)]
pub struct DatadogPipelineBuilder<R: Runtime> {
    service_name: String,
...
impl<R: Runtime> DatadogPipelineBuilder<R> {
    ...
    pub fn with_runtime<NewR: Runtime>(self, runtime: NewR) -> DatadogPipelineBuilder<NewR> {
        DatadogPipelineBuilder {
