...
pub(crate) mod tests {
    ...
    fn test_encode_v05() -> Result<(), Box<dyn std::error::Error>> {
        ...
        assert_eq!(encoded.as_str(), "kp+jd2VirHNlcnZpY2VfbmFtZaljb21wb25lbnSocmVzb3VyY2WpaG9zdC5uYW\
        1lpHRlc3Snc2VydmljZax0ZXN0LXNlcnZpY2WjZW52qHRlc3QtZW52p3ZlcnNpb26sdGVzdC12ZXJzaW9uqXNwYW4udH\
        lwZbVfc2FtcGxpbmdfcHJpb3JpdHlfdjGtX2RkMS5zci5lYXVzcpGRnM4AAAABzgAAAALOAAAAA88AAAAAAAAAB88AAA\
        AAAAAAY88AAAAAAAAAAdMAAAAAAAAAANMAAAAAO5rKANIAAAAAhc4AAAAEzgAAAAXOAAAABs4AAAAHzgAAAAjOAAAACc\
        4AAAAKzgAAAAvOAAAADM4AAAAAgs4AAAANywAAAAAAAAAAzgAAAA7LP/AAAAAAAADOAAAAAA==");
