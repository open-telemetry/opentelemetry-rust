...
impl<T> SyncCounter<T> for NoopSyncInstrument {
    fn add(&self, _value: T, _attributes: &[MetricAttribute<'_>]) {
        // Ignored
    }
}
...
impl<T> SyncHistogram<T> for NoopSyncInstrument {
    fn record(&self, _value: T, _attributes: &[MetricAttribute<'_>]) {
        // Ignored
    }
}
...
impl<T> AsyncInstrument<T> for NoopAsyncInstrument {
    fn observe(&self, _value: T, _attributes: &[MetricAttribute<'_>]) {
        // Ignored
    }
