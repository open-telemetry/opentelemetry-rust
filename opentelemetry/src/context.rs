...
impl Context {
    ...
    ///
    /// This method is designed for OpenTelemetry components (like Exporters and
    /// Processors) and for applications that isolate exporter work on dedicated
    /// execution contexts. It prevents recursive or self-referential telemetry
    ...
    ///
    /// OTel SDK components check `is_current_telemetry_suppressed()` before
    /// generating new telemetry. Application telemetry should not normally be
    /// emitted inside a suppressed scope.
    ///
    /// # Examples
    ///
    /// ```
