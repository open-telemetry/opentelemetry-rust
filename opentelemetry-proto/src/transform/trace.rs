...
use common::{to_nanos, Attributes, ResourceAttributesWithSchema};
use opentelemetry::trace;
use opentelemetry::trace::{Link, SpanId, SpanKind};
use opentelemetry_sdk::trace::SpanData;
use proto::resource::v1::Resource;
use proto::trace::v1::{span, status, ResourceSpans, ScopeSpans, Span, Status};
...
mod span_flags_tests {
    use super::proto::trace::v1::{Span, SpanFlags};
...
#[cfg(test)]
mod tests {
    use super::common::ResourceAttributesWithSchema;
    use super::proto::common::v1::any_value::Value;
    ...
    fn test_group_spans_by_resource_and_scope_single_scope() {
        ...
        let grouped_spans = super::group_spans_by_resource_and_scope(spans, &resource);
    ...
    fn test_scope_spans_uses_instrumentation_schema_url_not_resource() {
        ...
        let grouped_spans = super::group_spans_by_resource_and_scope(vec![span_data], &resource);
