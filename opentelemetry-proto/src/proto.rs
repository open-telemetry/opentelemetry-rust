...
pub mod tonic {
    macro_rules! include_tonic {
    ($package: tt) => {
            include!(concat!("proto/tonic", concat!("/", $package, ".rs")));
        };
    }
    ...
    pub mod collector {
        ...
        pub mod logs {
            pub mod v1 {
                include_tonic!("opentelemetry.proto.collector.logs.v1");
            }
        }
        ...
        pub mod metrics {
            pub mod v1 {
                include_tonic!("opentelemetry.proto.collector.metrics.v1");
            }
        }
        ...
        pub mod trace {
            pub mod v1 {
                include_tonic!("opentelemetry.proto.collector.trace.v1");
            }
        }
    }
    ...
    pub mod common {
        pub mod v1 {
            include_tonic!("opentelemetry.proto.common.v1");
        }
    }
    ...
    pub mod logs {
        pub mod v1 {
            include_tonic!("opentelemetry.proto.logs.v1");
        }
    }
    ...
    pub mod metrics {
        pub mod v1 {
            include_tonic!("opentelemetry.proto.metrics.v1");
        }
    }
    ...
    pub mod resource {
        pub mod v1 {
            include_tonic!("opentelemetry.proto.resource.v1");
        }
    }
    ...
    pub mod trace {
        pub mod v1 {
            include_tonic!("opentelemetry.proto.trace.v1");
        }
    }
