...
pub use crate::exporter::{
    ...
    OTEL_EXPORTER_OTLP_METRICS_HEADERS, OTEL_EXPORTER_OTLP_METRICS_INSECURE,
    OTEL_EXPORTER_OTLP_METRICS_PROTOCOL, OTEL_EXPORTER_OTLP_METRICS_TIMEOUT,
};
#[cfg(feature = "metrics")]
pub use crate::metric::{MetricsExporter, MetricsExporterBuilder, OtlpMetricPipeline};

#[cfg(feature = "logs")]
pub use crate::exporter::{
    OTEL_EXPORTER_OTLP_LOGS_CERTIFICATE, OTEL_EXPORTER_OTLP_LOGS_CLIENT_CERTIFICATE,
    OTEL_EXPORTER_OTLP_LOGS_CLIENT_KEY, OTEL_EXPORTER_OTLP_LOGS_ENDPOINT,
...
pub use crate::exporter::{
    DataType, HasExportConfig, WithExportConfig, OTEL_EXPORTER_OTLP_CERTIFICATE,
    ...
    OTEL_EXPORTER_OTLP_INSECURE, OTEL_EXPORTER_OTLP_PROTOCOL, OTEL_EXPORTER_OTLP_PROTOCOL_DEFAULT,
