...
impl TraceConfig {
    ...
    // .opentelemetry.proto.trace.v1.ProbabilitySampler probability_sampler = 2;


    pub fn get_probability_sampler(&self) -> &ProbabilitySampler {
        match self.sampler {
            ::std::option::Option::Some(TraceConfig_oneof_sampler::probability_sampler(ref v)) => v,
            _ => <ProbabilitySampler as ::protobuf::Message>::default_instance(),
        }
    }
    pub fn clear_probability_sampler(&mut self) {
        self.sampler = ::std::option::Option::None;
    }

    pub fn has_probability_sampler(&self) -> bool {
        match self.sampler {
            ::std::option::Option::Some(TraceConfig_oneof_sampler::probability_sampler(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_probability_sampler(&mut self, v: ProbabilitySampler) {
        self.sampler = ::std::option::Option::Some(TraceConfig_oneof_sampler::probability_sampler(v))
    }

    // Mutable pointer to the field.
    pub fn mut_probability_sampler(&mut self) -> &mut ProbabilitySampler {
        if let ::std::option::Option::Some(TraceConfig_oneof_sampler::probability_sampler(_)) = self.sampler {
        } else {
            self.sampler = ::std::option::Option::Some(TraceConfig_oneof_sampler::probability_sampler(ProbabilitySampler::new()));
        }
        match self.sampler {
            ::std::option::Option::Some(TraceConfig_oneof_sampler::probability_sampler(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_probability_sampler(&mut self) -> ProbabilitySampler {
        if self.has_probability_sampler() {
            match self.sampler.take() {
                ::std::option::Option::Some(TraceConfig_oneof_sampler::probability_sampler(v)) => v,
                _ => panic!(),
            }
        } else {
            ProbabilitySampler::new()
        }
    }
...
impl ::protobuf::Message for TraceConfig {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(TraceConfig_oneof_sampler::probability_sampler(ref v)) = self.sampler {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ...
                    self.sampler = ::std::option::Option::Some(TraceConfig_oneof_sampler::probability_sampler(is.read_message()?));
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.sampler {
            match v {
                ...
                &TraceConfig_oneof_sampler::probability_sampler(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, ProbabilitySampler>(
                "probability_sampler",
                TraceConfig::has_probability_sampler,
                TraceConfig::get_probability_sampler,
            ));
...
impl<'a> ::std::default::Default for &'a ProbabilitySampler {
    fn default() -> &'a ProbabilitySampler {
        <ProbabilitySampler as ::protobuf::Message>::default_instance()
    }
}

impl ProbabilitySampler {
    pub fn new() -> ProbabilitySampler {
        ::std::default::Default::default()
    }
    ...
    pub fn get_samplingProbability(&self) -> f64 {
        self.samplingProbability
    }
    pub fn clear_samplingProbability(&mut self) {
        self.samplingProbability = 0.;
    }

    // Param is passed by value, moved
    pub fn set_samplingProbability(&mut self, v: f64) {
        self.samplingProbability = v;
    }
}

impl ::protobuf::Message for ProbabilitySampler {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        if self.samplingProbability != 0. {
            os.write_double(1, self.samplingProbability)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                "samplingProbability",
                |m: &ProbabilitySampler| { &m.samplingProbability },
                |m: &mut ProbabilitySampler| { &mut m.samplingProbability },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<ProbabilitySampler>(
                "ProbabilitySampler",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static ProbabilitySampler {
        static instance: ::protobuf::rt::LazyV2<ProbabilitySampler> = ::protobuf::rt::LazyV2::INIT;
        instance.get(ProbabilitySampler::new)
    }
}

impl ::protobuf::Clear for ProbabilitySampler {
    fn clear(&mut self) {
        self.samplingProbability = 0.;
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for ProbabilitySampler {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ProbabilitySampler {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    proto.trace.v1\"\x85\x05\n\x0bTraceConfig\x12Z\n\x10constant_sampler\x18\
    \x01\x20\x01(\x0b2-.opentelemetry.proto.trace.v1.ConstantSamplerH\0R\x0f\
    constantSampler\x12c\n\x13probability_sampler\x18\x02\x20\x01(\x0b20.ope\
    ntelemetry.proto.trace.v1.ProbabilitySamplerH\0R\x12probabilitySampler\
    ...
    \x10\0\x12\r\n\tALWAYS_ON\x10\x01\x12\x11\n\rALWAYS_PARENT\x10\x02\"F\n\
    \x12ProbabilitySampler\x120\n\x13samplingProbability\x18\x01\x20\x01(\
    \x01R\x13samplingProbability\"'\n\x13RateLimitingSampler\x12\x10\n\x03qp\
    s\x18\x01\x20\x01(\x03R\x03qpsB~\n\x1fio.opentelemetry.proto.trace.v1B\
    \x10TraceConfigProtoP\x01ZGgithub.com/open-telemetry/opentelemetry-proto\
    /gen/go/collector/trace/v1b\x06proto3\
";
