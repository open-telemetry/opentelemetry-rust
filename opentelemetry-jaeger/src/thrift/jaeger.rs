...
impl Process {
    pub fn new<F2>(service_name: String, tags: F2) -> Process
    where
...
pub struct CollectorSyncClient<IP, OP>
where
    IP: TInputProtocol,
    OP: TOutputProtocol,
{
...
impl<IP, OP> CollectorSyncClient<IP, OP>
where
    IP: TInputProtocol,
    OP: TOutputProtocol,
{
...
impl<IP, OP> TThriftClient for CollectorSyncClient<IP, OP>
where
    IP: TInputProtocol,
    OP: TOutputProtocol,
{
...
impl<IP, OP> TCollectorSyncClientMarker for CollectorSyncClient<IP, OP>
where
    IP: TInputProtocol,
    OP: TOutputProtocol,
{
...
impl<H: CollectorSyncHandler> CollectorSyncProcessor<H> {
    pub fn new(handler: H) -> CollectorSyncProcessor<H> {
        CollectorSyncProcessor { handler }
    }
    fn process_submit_batches(
        &self,
        incoming_sequence_number: i32,
        i_prot: &mut dyn TInputProtocol,
        o_prot: &mut dyn TOutputProtocol,
    ) -> thrift::Result<()> {
        TCollectorProcessFunctions::process_submit_batches(
            &self.handler,
...
impl TCollectorProcessFunctions {
    pub fn process_submit_batches<H: CollectorSyncHandler>(
        handler: &H,
        incoming_sequence_number: i32,
        i_prot: &mut dyn TInputProtocol,
        o_prot: &mut dyn TOutputProtocol,
...
impl CollectorSubmitBatchesArgs {
    fn read_from_in_protocol(
        i_prot: &mut dyn TInputProtocol,
    ) -> thrift::Result<CollectorSubmitBatchesArgs> {
        i_prot.read_struct_begin()?;
...
impl CollectorSubmitBatchesResult {
    fn read_from_in_protocol(
        i_prot: &mut dyn TInputProtocol,
    ) -> thrift::Result<CollectorSubmitBatchesResult> {
        i_prot.read_struct_begin()?;
        ...
        loop {
            ...
            match field_id {
                0 => {
                    let list_ident = i_prot.read_list_begin()?;
                    let mut val: Vec<BatchSubmitResponse> =
        ...
        i_prot.read_struct_end()?;
        let ret = CollectorSubmitBatchesResult { result_value: f_0 };
        Ok(ret)
    }
    fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
