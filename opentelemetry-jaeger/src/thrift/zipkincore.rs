...
impl Span {
    pub fn new<F1, F3, F4, F5, F6, F8, F9, F10, F11, F12>(
        trace_id: F1,
        name: F3,
        id: F4,
        parent_id: F5,
...
pub struct ZipkinCollectorSyncClient<IP, OP>
where
    IP: TInputProtocol,
    OP: TOutputProtocol,
{
...
impl<IP, OP> TThriftClient for ZipkinCollectorSyncClient<IP, OP>
where
    IP: TInputProtocol,
    OP: TOutputProtocol,
{
...
impl<IP, OP> TZipkinCollectorSyncClientMarker for ZipkinCollectorSyncClient<IP, OP>
where
    IP: TInputProtocol,
    OP: TOutputProtocol,
{
...
impl<C: TThriftClient + TZipkinCollectorSyncClientMarker> TZipkinCollectorSyncClient for C {
    fn submit_zipkin_batch(&mut self, spans: Vec<Span>) -> thrift::Result<Vec<Response>> {
        ...
        })?;
        {
            ...
            let result =
                ZipkinCollectorSubmitZipkinBatchResult::read_from_in_protocol(self.i_prot_mut())?;
            self.i_prot_mut().read_message_end()?;
            result.ok_or()
        }
    }
...
impl<H: ZipkinCollectorSyncHandler> ZipkinCollectorSyncProcessor<H> {
    pub fn new(handler: H) -> ZipkinCollectorSyncProcessor<H> {
        ZipkinCollectorSyncProcessor { handler }
    }
    fn process_submit_zipkin_batch(
        &self,
        incoming_sequence_number: i32,
        i_prot: &mut dyn TInputProtocol,
        o_prot: &mut dyn TOutputProtocol,
    ) -> thrift::Result<()> {
        TZipkinCollectorProcessFunctions::process_submit_zipkin_batch(
            &self.handler,
...
impl TZipkinCollectorProcessFunctions {
    pub fn process_submit_zipkin_batch<H: ZipkinCollectorSyncHandler>(
        handler: &H,
        incoming_sequence_number: i32,
        i_prot: &mut dyn TInputProtocol,
        o_prot: &mut dyn TOutputProtocol,
...
impl ZipkinCollectorSubmitZipkinBatchArgs {
    fn read_from_in_protocol(
        i_prot: &mut dyn TInputProtocol,
    ) -> thrift::Result<ZipkinCollectorSubmitZipkinBatchArgs> {
        i_prot.read_struct_begin()?;
...
impl ZipkinCollectorSubmitZipkinBatchResult {
    fn read_from_in_protocol(
        i_prot: &mut dyn TInputProtocol,
    ) -> thrift::Result<ZipkinCollectorSubmitZipkinBatchResult> {
        i_prot.read_struct_begin()?;
        ...
        i_prot.read_struct_end()?;
        let ret = ZipkinCollectorSubmitZipkinBatchResult { result_value: f_0 };
        Ok(ret)
    }
    fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
